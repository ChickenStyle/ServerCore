...
public class MediumMeteor extends BlockPopulator{

	@Override
	public void populate(World world, Random random, Chunk chunk) {
		
		if (new Random().nextDouble() < 0.00048828125) {
			Material[] ores = {
					Material.OBSIDIAN,
					Material.OBSIDIAN,
					Material.OBSIDIAN,
		    ...
		    Utils.generateMeteor(centerLoc, 7, air);
		    Utils.generateMeteor(centerLoc.subtract(0, 2, 0), 5, ores);
			return;
		}
	}
