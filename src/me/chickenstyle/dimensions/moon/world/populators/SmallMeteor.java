...
public class SmallMeteor extends BlockPopulator{

	@Override
	public void populate(World world, Random random, Chunk chunk) {
		
		if (new Random().nextDouble() < 0.0009765625) {
			Material[] ores = {
					Material.OBSIDIAN,
					Material.OBSIDIAN,
					Material.OBSIDIAN,
		    ...
		    Utils.generateMeteor(centerLoc, 5, air);
		    Utils.generateMeteor(centerLoc.subtract(0, 2, 0), 3, ores);
			return;
		}
	}
